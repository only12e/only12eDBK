...
INSERT INTO `base_userlog` VALUES ('1970044243355373568', '2025-09-22 16:35:24', 'Admin', '超级管理员', '博客管理', '修改文章:深入理解Vue.js响应式系统');
INSERT INTO `base_userlog` VALUES ('1970048722758799360', '2025-09-22 16:53:12', 'Admin', '超级管理员', '博客管理', '添加文章:冯绍峰是否');
INSERT INTO `base_userlog` VALUES ('1970049038816382976', '2025-09-22 16:54:27', 'Admin', '超级管理员', '博客管理', '修改文章:冯绍峰是否');
...
) ENGINE = MyISAM AUTO_INCREMENT = 31 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '博客文章表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of blog_articles
-- ----------------------------
INSERT INTO `blog_articles` VALUES (1, '深入理解Vue.js响应式系统', 'Vue.js的响应式系统是其核心特性之一，本文将深入解析其实现原理', '<p>反反复复凤飞飞反反复复发发发发发发发发发发发发发发发发发发发</p>', 'http://192.168.124.23:5000/Upload/2025/09/09/eca3d0a0faf140e691dedcfb0920f00e.jpg', 1, 'published', 1, 156, 1, 4, '2025-09-05 10:30:00', '2025-09-05 10:20:00', '2025-09-22 16:35:24', 'Admin');
INSERT INTO `blog_articles` VALUES (2, '使用Node.js构建RESTful API最佳实践', '分享在Node.js中构建RESTful API的经验和最佳实践', '<h1>Node.js RESTful API最佳实践</h1><p>构建一个高质量的RESTful API需要遵循一些最佳实践...</p><h2>项目结构</h2><p>良好的项目结构是成功项目的基础：</p><pre><code>project/\n├── controllers/\n├── models/\n├── routes/\n├── middleware/\n├── utils/\n└── app.js\n</code></pre><h2>错误处理</h2><p>统一的错误处理机制非常重要：</p><pre><code>// 全局错误处理中间件\napp.use((err, req, res, next) =&gt; {\n  res.status(err.status || 500).json({\n    message: err.message,\n    stack: process.env.NODE_ENV === \'development\' ? err.stack : {}\n  })\n})\n</code></pre>', 'http://192.168.124.23:5000/Upload/2025/09/09/eca3d0a0faf140e691dedcfb0920f00e.jpg', 1, 'published', 1, 89, 2, 0, '2025-09-05 11:00:00', '2025-09-05 10:50:00', '2025-09-22 13:21:25', 'Admin');
...
) ENGINE = MyISAM AUTO_INCREMENT = 32 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '博客评论表' ROW_FORMAT = Dynamic;
...
INSERT INTO `blog_comments` VALUES (31, '梗塞格式色鬼色鬼', 'article', 30, 1758531283531, 0, 'approved', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36 Edg/140.0.0.0', '2025-09-22 16:54:49', '2025-09-22 16:54:49', '1', 0);
INSERT INTO `blog_comments` VALUES (30, '方法发发疯', 'article', 30, NULL, 0, 'approved', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36 Edg/140.0.0.0', '2025-09-22 16:54:43', '2025-09-22 16:54:43', '1', 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 64 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户点赞表' ROW_FORMAT = Dynamic;
...
INSERT INTO `blog_likes` VALUES (63, 'Admin', 'article', 30, '2025-09-22 16:54:37');
...
CREATE TABLE `blog_technologies`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '技术栈ID，主键',
...
CREATE TABLE `blog_tools`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '工具ID，主键',
